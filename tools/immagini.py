...
RICETTE = [
    ...
    # La copertina di Courmayeur resta vuota finche' non c'e' una foto vera
    # dello chalet: mettila in originali/chalet-quota.jpg e scommenta la riga.
    # ("sfascio-cover", "chalet-quota.jpg",      "4-5",  0.50, 0.50),
    # ---- schede destinazione ----
